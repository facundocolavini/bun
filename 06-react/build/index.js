...
// node_modules/scheduler/cjs/scheduler.devel
...
var init_web_vitals = __esm(() => {
  ...
  f = function(e2, n2) {
    ...
    return { name: e2, value: n2 === undefined ? -1 : n2, rating: "good", delta: 0, entries: [], id: "v3-".concat(Date.now(), "-").concat(Math.floor(8999999999999 * Math.random()) + 1000000000000), navigationType: r2 };
  };
  s = function(e2, n2, t2) {
    try {
  ...
  Q = function(e2, n2) {
    n2 = n2 || {}, C(function() {
      var t2;
      q();
      var r2, i2 = f("INP"), a2 = function(e3) {
        e3.forEach(function(e4) {
      ...
      }, c2 = s("event", a2, { durationThreshold: (t2 = n2.durationThreshold) !== null && t2 !== undefined ? t2 : 40 });
      r2 = d(e2, i2, j, n2.reportAllChanges), c2 && (("interactionId" in PerformanceEventTiming.prototype) && c2.observe({ type: "first-input", buffered: true }), p(function() {
        a2(c2.takeRecords()), i2.value < 0 && z() > 0 && (i2.value = 0, i2.entries = []), r2(true);
      }), o(function() {
        G = [], _ = O(), i2 = f("INP"), r2 = d(e2, i2, j, n2.reportAllChanges);
      }));
    });
  };
  U = [2500, 4000];
...
var App = function() {
  return jsx_dev_runtime.jsxDEV("div", {
    className: "App",
    role: "main",
    children: jsx_dev_runtime.jsxDEV("article", {
...
root.render(jsx_dev_runtime2.jsxDEV(React.StrictMode, {
